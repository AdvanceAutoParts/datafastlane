...
/**
 * Uses a recipe file that executes a JDBC load and a CSV load.
 */
class JdbcCsvTransformLoadTest {
    ...
    @Test
    void test() {
        DataStore store = new DataStore("src/test/resources/recipe-jdbc-csv.yaml");
