...
/**
 * Uses a recipe file that executes a single JDBC load where the dataframe
 * name is different from the table name.
 */
class JdbcTransformLoadDataframeTablenameMismatchTest {
  ...
  void test() {
    DataStore store = new DataStore(
        "src/test/resources/recipe-jdbc-dataframe-source-different.yaml");
