...
/**
 * A transformation starts to work on a name and has operations, which can have argument.
 */
public class Attribute {

    /**
     * An name can be a column or a dataframe, it composes the current dataframe or store.
     */
    ...
    public Operation getOperation(String name) {
        return (operations != null ?
                                   operations.stream().filter(o -> o.getName().equals(name)).findFirst().orElse(null) :
                                   null);
    }
