...
public class LoadOperation extends CoreOperation {
    private static final Logger log = LoggerFactory.getLogger(LoadOperation.class);
    ...
    public boolean run() {
        ...
        if (operationDefinition != null && store != null) {
            ...
            log.debug("Row count call completed in {} seconds. Loaded {} records.",
        ...
        log.debug("Run of {} completed in {} seconds with a status of {}", this.getClass().getName(),
     ...
     * 
     * @return
     * @deprecated This is an expensive operation that should not be done here.
     */
