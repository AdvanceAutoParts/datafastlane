...
/**
 * A Spark UDF that will generate a UUID from any number of columns from a dataframe.
 */
public class UuidGeneratorUdf implements UDF1<Seq<Object>, String> {
    private static final Logger log = LoggerFactory.getLogger(UuidGeneratorUdf.class);
    ...
    public String call(Seq<Object> t1) throws Exception {
        List<Object> listA = scala.collection.JavaConverters.seqAsJavaListConverter(t1).asJava();
