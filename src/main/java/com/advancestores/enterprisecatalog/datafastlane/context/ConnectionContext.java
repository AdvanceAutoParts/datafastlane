...
/**
 * The connection context will have some standard items as "first class" properties. Other properties may be added to a
 * map. This will provide flexibility to the connection context object.
 */
public class ConnectionContext extends BaseContext {
    // for convenience - some standard properties that are typically used in a connection config
