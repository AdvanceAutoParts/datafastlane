...
public abstract class K {
    ...
    public static final String KEY_SPARK_MEMORY_OFFHEAP_ENABLED = "spark.memory.offHeap.enabled";
    public static final String KEY_SPARK_MEMORY_OFFHEAP_SIZE = "spark.memory.offHeap.size";
    ...
    public static final String KEY_AWS_SECRET_ACCESS_KEY = "aws_secret_access_key";
